...
const steps = [
  {
    number: "01",
    title: "Add Huginn",
    description: "Add @Huginn to any WhatsApp group with a single message. No registration, no email, no app required.",
    code: `// In your WhatsApp group, type:
/add @Huginn

// ✓ Huginn joins instantly
// ✓ Ready to track matches`,
  },
  {
    number: "02",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          >
            ...
            <br />
            <span className="text-balance">live coverage.</span>
          </h2>
        </div>
          ...
          <div className="lg:sticky lg:top-32">
            <div className="rounded-xl overflow-hidden bg-card border border-border card-shadow">
              ...
              <div className="px-4 py-3 border-b border-border flex items-center gap-3 bg-secondary/30">
                ...
                <span className="text-xs font-mono text-muted-foreground">huginn.setup</span>
              </div>
